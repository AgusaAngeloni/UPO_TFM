...
python Python/RidgeCV.py --n_jobs=$SLURM_CPUS_PER_TASK
python Python/RandomForest.py --n_jobs=$SLURM_CPUS_PER_TASK
python Python/ElasticNet.py --n_jobs=$SLURM_CPUS_PER_TASK
